...
if(rootApplication.includes('invoices-header-actions-fix')||rootApplication.includes('invoices-header-layout.css')||!rootApplication.includes('invoices-chrome.css'))fail('Invoices must use the consolidated chrome contract without obsolete header fix layers.');
