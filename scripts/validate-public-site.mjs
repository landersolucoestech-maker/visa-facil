...
const marketingRefinementCss = read('apps/web/src/styles/marketing-refinement.css');
const marketingOverviewRefinementCss = read('apps/web/src/styles/marketing-overview-refinement.css');
...
assert(marketingApp.includes('className="marketing-bell"') && marketingApp.includes('<BellIcon />') && marketingRefinementCss.includes('.marketing-bell>svg') && !marketingRefinementCss.includes('data:image/svg+xml'), 'Marketing notification control must style the rendered bell SVG instead of duplicating it as a CSS data image');
...
for (const css of ['apps/web/src/styles/app-baseline.css','apps/web/src/modules/public-site/styles/01-base.css','apps/web/src/modules/public-site/styles/02-sections-responsive.css','apps/web/src/modules/public-site/styles/03-hero-v3.css','apps/web/src/modules/crm/crm.css','apps/web/src/modules/site-cms/site-cms-base.css','apps/web/src/modules/contracts/contracts.css','apps/web/src/modules/finance/finance.css','apps/web/src/modules/finance/finance-accounting.css','apps/web/src/modules/finance/finance-config.css','apps/web/src/modules/reports/reports.css','apps/web/src/modules/tasks/tasks.css','apps/web/src/modules/settings/settings.css','apps/web/src/modules/settings/settings-responsive.css','apps/web/src/modules/settings/settings-layout.css','apps/web/src/styles/marketing-refinement.css','apps/web/src/styles/marketing-overview-refinement.css','apps/web/src/styles/invoices-chrome.css','apps/web/src/styles/crm-ui-standard.css']) assert(existsSync(resolve(root, css)), `Missing stylesheet: ${css}`);
