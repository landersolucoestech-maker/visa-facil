...
assert(containsAll(crmSidebar, ["../modules/crm/crm.css", "../styles/sidebar-v2.css"]) && !crmSidebar.includes("../styles/ui-system.css") && !crmSidebar.includes("../styles/product-refinement.css") && !crmSidebar.includes("../styles/crm-header-actions-unified.css") && containsAll(rootApp, ["./styles/crm-content-layout.css", "./styles/crm-ui-standard.css", "./styles/crm-ui-enforcement.css", "./styles/tableview-surface.css"]), 'Shared CRM chrome must be owned by the root CRM shell while sidebar-only styles remain lazy with CrmSidebar');
