    ...
    <section className="hero" aria-label="Destaques VISA FÁCIL">
      <div className="hero-slider hero-slider--background" data-hero-slider="" aria-label="Destaques e campanhas">
        <article className="hero-slide is-active" data-hero-slide="">
          <img src="https://images.unsplash.com/photo-1485738422979-f5c462d49f74?auto=format&fit=crop&w=1800&q=90" alt="Estátua da Liberdade e skyline de Nova York" />
        </article>
        ...
        <div className="hero-slider__dots" aria-label="Selecionar banner">
          <button className="hero-slider__dot is-active" type="button" aria-label="Mostrar banner 1" data-hero-dot="0"></button>
          <button className="hero-slider__dot" type="button" aria-label="Mostrar banner 2" data-hero-dot="1"></button>
          <button className="hero-slider__dot" type="button" aria-label="Mostrar banner 3" data-hero-dot="2"></button>
        </div>
      </div>
