...
export function ManagementApp() {
  ...
  const topbarTools = <div className="management-topbar__actions"><NotificationCenter tasks={tasks} conversations={conversations} documents={documents} onNavigate={navigate} /></div>;
