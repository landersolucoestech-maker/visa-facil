...
type ManagementShellProps = { children: ReactNode; path: string; onNavigate: (path: string) => void; search?: ReactNode };
...
function UsaFlagDetail() { return <div className="management-us-flag" aria-hidden="true"><div className="management-us-flag__canton">★ ★ ★<br/> ★ ★ ★<br/>★ ★ ★</div><div className="management-us-flag__stripes">{Array.from({length:7},(_,index)=><i key={index} />)}</div></div>; }

export function ManagementShell({ children, path, onNavigate, search }: ManagementShellProps) {
