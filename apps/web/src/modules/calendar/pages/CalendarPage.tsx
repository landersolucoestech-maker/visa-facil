...
export function CalendarPage({ clients, processes, tasks }: CalendarPageProps) {
  ...
  return <section className="management-page calendar-page" aria-labelledby="calendar-title">
    <div className="management-page__heading management-page__heading--row"><div><span className="management-eyebrow">Planejamento</span><h1 id="calendar-title">Agenda</h1><p>Visão temporal de prazos de tarefas e datas-alvo dos processos, organizada por calendário mensal e próximos compromissos.</p></div><button className="management-secondary-button" type="button" onClick={()=>setCursor(new Date(today.getFullYear(),today.getMonth(),1))}>Hoje</button></div>
