...
const ICONS:Record<IntegrationId,string>={whatsapp:'WA','telephony-sms':'SMS',autentique:'A',nfse:'NF',instagram:'IG',facebook:'FB',youtube:'YT',tiktok:'TT','google-ads':'GA','google-calendar':'GC'};
